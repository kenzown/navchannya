...
divk.className = 'wrap collapse alpha beta'
// - додати стилі(довільні значення) : колір фону, колір тексту, розмір тексту
divk.style.background = 'red';
divk.style.color = 'blue';
divk.style.fontSize = '20px'
divk.innerText = 'доброго дня'

// - додати цей блок в body.
document.body.appendChild(divk)
// - клонувати його повністю, та додати клон в body.
document.body.append(divk.cloneNode(true))
//
// - Є масив:
...
for (const string of arr) {
    let lol = document.getElementsByClassName('menu')[0];
    let mkm = document.createElement('li');
    mkm.innerText = string;
    lol.appendChild(mkm)
}
//
// - Є масив
...
//     Завдання робити через цикли.
for (const itemss of coursesAndDurationArrayy) {
    let divElement = document.createElement('div');
    divElement.className = 'item'
    let htmlHeadingElement = document.createElement('h2');
    htmlHeadingElement.innerText = `${itemss.title}`
    let paragraphElement = document.createElement('p');
    paragraphElement.innerText = `${itemss.monthDuration}`
    divElement.append(htmlHeadingElement, paragraphElement)
...
for (const simpson of simpsons) {
    ...
    htmlDivElement.append(name, Surname, age, info, photo)
...
for (const items of coursesArray) {
    ...
    element.innerText = items.title
    const divElement2 = document.createElement("div");
    divElement2.innerText = items.monthDuration;

    const divElement3 = document.createElement('p');
    divElement3.innerText = items.hourDuration

    const divElement4 = document.createElement('p');
    divElement4.innerText = items.modules
    divElement1.append(element, divElement2, divElement3, divElement4)
